...
| Prompt 变短一定更快 | 精简后若触发 V4 **Thinking**，`reasoning_tokens` 会拉高耗时 — 见 [M11.1-slim-prompt-reasoning-latency.md](M11.1-slim-prompt-reasoning-latency.md) |
...
- 精简后反而变慢（Reasoning）：[M11.1-slim-prompt-reasoning-latency.md](M11.1-slim-prompt-reasoning-latency.md)
